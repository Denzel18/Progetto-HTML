...
class Application_Form_Staff_Auto_Add extends App_Form_Abstract {

    protected $_TargaValidator;
    protected $_IntValidator;
    protected $_FloatValidator;


    public function init() {
        $this->_TargaValidator = new Zend_Validate_Db_NoRecordExists('Auto','Targa');
        ...
        $this->addElement('text', 'Targa', array(
            ...
            'validators' => array('Targa exists'=>$this->_TargaValidator),
